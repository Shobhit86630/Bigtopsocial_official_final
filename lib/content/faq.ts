...
export const faqItems: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Early signals often appear within a few weeks for paid and content programs, while compounding growth typically builds over 60–90 days as creative, targeting, and landing experiences iterate. We set expectations up front based on your funnel and channel mix.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "We align on KPIs before launch (pipeline, CAC, ROAS, engagement quality, conversion rate, LTV proxies, etc.) and report on them consistently. Dashboards, weekly summaries, and decision notes keep teams focused on outcomes—not vanity metrics.",
  },
];
